...
const DEFAULT_PRODUCTS = [
  {
    ...
    price_cents: 6900,
    image_url: "assets/products/glp-3rt-10mg-float.png",
    is_active: true,
  },
  {
    id: "glp-3rt-30mg",
    ...
    description: "Research peptide supplied for laboratory catalog workflows. Lot-verified documentation available.",
    price_cents: 12900,
    image_url: "assets/products/glp-3rt-30mg-float.png",
    is_active: true,
  },
  {
    id: "glp-2tz-20mg",
    ...
    price_cents: 14900,
    image_url: "assets/products/glp-2tz-float.png",
    is_active: false,
  },
  {
    id: "glp-2tz-30mg",
  ...
  },
  {
    ...
    price_cents: 3900,
    image_url: "assets/products/ghk-cu-float.png",
    is_active: true,
  },
  {
    id: "mots-c-10mg",
    ...
    price_cents: 4900,
    image_url: "assets/products/mots-c-float.png",
    is_active: true,
  },
  {
    id: "mots-c-50mg",
...
function randomOrderNumber() {
  ...
  for (let index = 0; index < 8; index += 1) {
    suffix += ORDER_NUMBER_ALPHABET[crypto.randomInt(ORDER_NUMBER_ALPHABET.length)];
  }
  return `GMP-${suffix}`;
}
...
function calculateTotals(items) {
  ...
  const shippingCents = centsFromEnv("FLAT_SHIPPING_CENTS", 1200);
...
function validateCheckoutPayload(payload) {
  ...
  const requiresAddressVerification = Boolean(process.env.PUBLIC_GOOGLE_MAPS_API_KEY);
  ...
  if (
    ...
    (requiresAddressVerification && shipping.addressVerified !== true) ||
